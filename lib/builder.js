...
deployApp = (sProjname, Package, Bsp, Bsp_text, Transport) => {
    ...
    sCommand += " --base ./dist "
    // Server
    sCommand += " --conn_server \"http://" + process.env.GW_URL + ":8000\" "
    // User
    sCommand += " --conn_user \"" + process.env.GW_USR + "\" "
    // Password
    sCommand += " --conn_password \"" + process.env.GW_PWD + "\" "
    // Package
